...
async def post_confirm(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Yangi elonni guruhga avtomatik joylash
    try:
        listing = db.get_listing(listing_id)
        await send_listing_card(context, CHANNEL_USERNAME, listing)
    except Exception as e:
        logger.warning(f"Elon guruhga yuborilmadi (ID {listing_id}): {e}")
